...
#define BAR_FONT       "Dejavu Sans Mono:pixelsize=10", "Standard Symbols:pixelsize=10", "FreeSerif:pixelsize=10", "Symbola:pixelsize=10"
/* Some fonts don't set the right width for some chars, pheex it */
#define BAR_FONT_FALLBACK_WIDTH 6
/* Define the opacity of the bar (requires a compositor such as compton) */
#define BAR_OPACITY 0.8 /* 0 is invisible, 1 is opaque */
/* Color palette */
